...
export const CURRENT_CONTENT_RELEASE = {
  id: "pragma_content_candidate_20260825_03_grounded_feedback",
  lifecycle: "candidate",
  corePromptVersions: [
  ...
  missionPromptVersions: [
    "mission_v5_mpj5_minidiscourse_v7_boundary_contrast",
  ...
  qualityPromptVersions: {
    ...
    mission: "quality_v9_grounded_boundary_contrast",
  },
} as const;
