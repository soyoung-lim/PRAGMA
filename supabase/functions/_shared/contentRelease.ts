...
export const CURRENT_CONTENT_RELEASE = {
  id: "pragma_scope_lock_20260829_05_mjt5_dct1_candidate_blueprint",
  lifecycle: "candidate",
  corePromptVersions: [
  ...
  missionPromptVersions: [
    "mission_v5_mpj5_minidiscourse_v10_candidate_blueprint",
  ...
  qualityPromptVersions: {
    ...
    mission: "quality_v15_candidate_blueprint_consistency",
  },
} as const;
