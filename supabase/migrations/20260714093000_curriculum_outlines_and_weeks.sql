-- Curriculum outline skeleton: macro-layer 15-week planner.
-- Admin-only internal content (single operator). Reuses existing helpers
-- public.tg_set_updated_at() and public.is_admin() (NOT redefined here).
-- Scope: two tables only. No scenario linkage, no seed data, no type/enum
-- changes to scenarios.speech_act. Speech acts stored as text (9-way, no
-- SPEECH_ACT_UI_TO_INTERNAL collapse), validated by text + CHECK.

-- ============================================================================
-- 1) curriculum_outlines — one row per semester curriculum
-- ============================================================================
...
-- ============================================================================
-- 2) curriculum_weeks — N rows per outline (one per week)
-- ============================================================================
...
-- ============================================================================
-- 3) Table privileges (row access still gated by RLS below)
-- ============================================================================
...
-- ============================================================================
-- 4) Row Level Security — admin only (no authenticated learner SELECT policy)
-- ============================================================================
...
-- ============================================================================
-- 5) updated_at triggers (reuse existing public.tg_set_updated_at())
-- ============================================================================
