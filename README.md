...
| 학습 구인 | 구성 |
|---|---|
| 목표 화행 | 요청 · 거절 · 감사 · 사과 · 제안 · 초대 · 반대 · 칭찬 · 직접 불만 (9개) |
| 상황 변수 | 상대적 권력(P) · 사회적 거리(D) · 상황 부담(R) 각 3수준 |
| 수행 방식 | 한→중 · 중→한 × 번역 · 통역 |
| 지원 수준 | 입문 · 중급 · 고급 |
...
※ 과제 명칭은 대외적으로 **MJT**(메타화용적 판단 과제)·**DCT**(담화완성과제)를 사용합니다. 코드·DB의 내부 식별자는 개발 이력 보존을 위해 당시 명칭 `mpj*`를 유지합니다.
...
| 학습 수행 | MJT 선택 trace, 최초 산출, 피드백 snapshot, 수정 산출, 학습자 이견 |
