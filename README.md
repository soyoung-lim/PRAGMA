...
화행 기반 한↔중 통번역 **화용적 적절성** 학습 웹앱. 학습자는 시나리오를 받아 P·D·R(상대적 권력·사회적 거리·행위 부담도)을 판단하고, 후보 표현을 비교·선택하며, 최종안을 제출합니다. 관리자는 시나리오를 생성·검토하고 학습 로그(decision traces)를 분석합니다.
