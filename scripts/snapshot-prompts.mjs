...
const prompts = [
  ...
  entry("quality.system", "프롬프트 통제 기반 검토 · 지시문", "review",
    "생성과 분리된 AI가 버전이 관리되는 지시문으로 미션을 검토한다(계약 0-n·94).",
    S.buildQualitySystemPrompt("ko_zh", "PROBE_ACT")),
  entry("core_quality.system", "코어 설계축 검토 · 지시문", "review",
    "화행·P/D/R·사건 대응·통역 역할 분리·학생용 장면 누출을 생성 AI와 분리해 검토한다.",
