...
| 운영 DB | Supabase project `tlnjxagqwvefeqdagtkq`; 저장소 최신 시작 migration `20260827190000_content_review_workflow.sql` | 코드 기준 고정, 원격 migration 목록 재열거는 적용 게이트에서 수행 |
...
- migration 원격 적용, batch 유료 실행, 30파일럿 판정, 교수자 최종 승인
