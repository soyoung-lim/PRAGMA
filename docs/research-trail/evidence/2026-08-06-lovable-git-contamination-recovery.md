...
- 사건일: 2026-08-06
- 오염 커밋: `004a04a77faddd13bbe6f229aadfcb836f5da898`,
  `5a2c5d5d7088abfa0146378bb34495704e6b5206`
...
| 대상 | 관찰 |
|---|---|
| `004a04a` | npm 프로젝트에 `bun.lock` 1,363줄 신규 추가 |
| `5a2c5d5` | Supabase 타입 548줄 감소, public table 20→12·RPC 6→3 |
| `26894ce` | 과거 `bun.lockb`를 제거해 npm 배포로 통일 |
| `d0f2477` | 다시 들어온 `bun.lock`을 제거해 Nixpacks npm 사용을 유지 |
...
|---|---:|---:|---:|---|
| Lovable `5a2c5d5` | 31,121 | 12 | 3 | 최신 앱·DB 정의 소실 |
| Git `b63784c` | 48,673 | 20 | 6 | 필수 정의는 있으나 최신 원장 table/RPC 누락 |
| 운영 DB 재생성 | 51,937 | 21 | 7 | 채택 |

운영 DB 재생성본은 `b63784c`에 없던 `llm_invocation_events`와
...
같다. 사용자 지시서의 `b63784c` 주장과 일치하지 않으므로 직접 조회 사실을 보존한다.

- deployment: `01a9cf65-2212-4394-b938-210772a0de96`
- commit: `5a2c5d5d7088abfa0146378bb34495704e6b5206`
