...
- 표적 2파일 3 tests와 typecheck가 통과했다. 실제 개발 데이터 2명의 로컬 화면에서 목록과 상세 모달을 확인했고, 980px 최소 폭에서 발생한 버튼 잘림을 860px 최소 폭과 관리 열 확대 조정으로 해소했다. 이 추가 변경은 아직 커밋·푸시·운영 배포하지 않았다.
