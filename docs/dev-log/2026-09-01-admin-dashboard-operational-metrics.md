...
1. 바뀐 수치: 대시보드에 현행 분모 1,623 코어·235 생성 미션·213 검수 대상·2 최종 승인과 5단계 다음 작업 212/0/0/0/1을 표시. 전체 693 tests 통과·9 skip, Railway SUCCESS.
2. 바뀐 화면: `/admin/dashboard`를 콘텐츠 준비·검수 진행·수업/학습 3영역으로 교체하고, 후속 운영 피드백으로 카드·간격·설명을 압축. `/admin/review`의 호환 상태 카드 분모·라벨도 명확화.
