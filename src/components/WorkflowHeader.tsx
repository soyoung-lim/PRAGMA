                ...
                <button
                  ...
                  className={[
                    ...
                    isCurrent
                      ...
                      : isDone
                      ? "bg-background border border-foreground text-foreground font-medium"
                      : "bg-background border border-muted-foreground/30 text-muted-foreground/70 font-normal",
