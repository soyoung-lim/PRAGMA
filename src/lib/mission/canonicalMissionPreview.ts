  ...
  lessonPoints: [
    {
      questId: "A1",
      label: "첫인상 판단",
      text: "请给我写一封推荐信 → 가능 여부 없이 큰 부탁을 바로 요구",
      highlights: ["请给我写一封推荐信"],
    },
    {
      questId: "A2",
      label: "상황 비교",
      text: "有点冷，把空调调小一点吧 → 친한 룸메이트·낮은 부담에는 자연스러움",
      highlights: ["有点冷，把空调调小一点吧"],
    },
    {
      questId: "A3",
      label: "고쳐 보기",
      text: "喂 → 助教您好，请问…… : 첫 연락에는 호칭과 열기",
      highlights: ["喂", "助教您好，请问……"],
    },
    {
      questId: "A4",
      label: "이유 찾기",
      text: "一下 ≠ 선택권: 把……发我一下은 여전히 직접적",
      highlights: ["一下", "把……发我一下"],
    },
    {
      questId: "A5",
      label: "BEST·WORST",
      text: "能帮忙吗 = BEST / 务必 = WORST: 가능 여부 묻기 vs 행동 정하기",
      highlights: ["能帮忙吗", "务必"],
    },
  ],
  quests: [
