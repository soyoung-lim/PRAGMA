...
describe("mission_v6 learner gates", () => {
  ...
  it("requires all three MultiJudge classifications", () => {
    expect(canSubmitMultiJudge(3, { 0: "under", 1: "within" })).toBe(false);
    expect(canSubmitMultiJudge(3, { 0: "under", 1: "within", 2: "over" })).toBe(true);
  });
