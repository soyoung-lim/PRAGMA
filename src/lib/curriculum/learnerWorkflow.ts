...
//
// 원칙:
//  - 학습자에게는 행동 동사를 보이고, 대외 연구 표기(MJT·DCT)는 작은 보조 라벨로만 남긴다.
...
// Hook·Orientation → 귀납 관찰 → 명시적 원리 설명 → 수용은
// 목표 특징 최초 도입 시 1회 도는 도입 아크(IntroArc·L1~L4)다.
// 주차 강의 유인물의 열람을 이 교수 단계의 수행으로 간주하지 않는다.
