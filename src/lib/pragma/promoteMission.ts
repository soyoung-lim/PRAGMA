...
import { normalizeMission, QualityCheckSchema, type MissionRuntime, type QualityCheck } from "@/lib/pragma/missionSchema";
...
export async function promoteCore(core: PromotableCore): Promise<PromoteResult> {
  ...
  let mission: MissionRuntime | undefined; // legacy mission_v1..v5와 현행 mission_v6를 모두 읽는 런타임 형태
