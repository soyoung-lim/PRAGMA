...
const INVITATION_CHOICE_COMMITMENT: TargetFeature = {
  ...
  operational_definition:
    ...
    "대역 경계: 참여가 의무이거나 이미 결정된 것처럼 전제하고 거절의 비용·불이익·반복 압박을 두면 too_pressuring이다. 행사와 참여 행위가 문맥에서 식별되고 상대에게 수락 여부가 남으면 within_band이며, 希望您能参加·欢迎您来 같은 통상적 희망·환영형은 그 자체로 압박이 아니다. " +
    "too_ambiguous는 문맥 전체를 보아도 무엇에 참여하는지 또는 초대 의도를 알아볼 수 없을 때만 쓴다. 이미 상황·원문에 제시된 행사 정보를 매 후보가 반복하지 않거나, 다른 일정·불참 가능성을 제시해 선택권을 넓힌다는 이유만으로 모호하다고 판정하지 않는다.",
  band_schema: [
  ...
  operational_definition_zh_ko:
    ...
    "여러 번 권하거나 설득하는 것을 진정성의 자동 기준으로 삼지 않는다. " +
    "대역 경계: 참여가 의무이거나 이미 결정된 것처럼 전제하고 거절의 비용·불이익·반복 압박을 두면 too_pressuring이다. 행사와 참여 행위가 문맥에서 식별되고 상대에게 수락 여부가 남으면 within_band이며, '참석해 주시면 좋겠습니다'·'함께해 주시면 좋겠습니다' 같은 통상적 희망형은 그 자체로 압박이 아니다. " +
    "too_ambiguous는 문맥 전체를 보아도 무엇에 참여하는지 또는 초대 의도를 알아볼 수 없을 때만 쓴다. 이미 상황·원문에 제시된 행사 정보를 매 후보가 반복하지 않거나, '일정이 맞지 않으면 조정하겠습니다'처럼 선택권을 넓힌다는 이유만으로 모호하다고 판정하지 않는다.",
  relevant_resources_zh_ko: [
